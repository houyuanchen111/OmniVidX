...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        **kwargs 
        ...
        modality_data = {
                "modality_index": None,
                "input_videos": [data.get("normal", None)],
        ...
        video_dict = {}
        inputs_shared["modality_index"] = torch.tensor([4], device=self.device) # 强制算normal的loss
...
class WanTrainingModule_wan2_1_fun_1_3b_control_normal_lora_image_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
    ...
    def forward_preprocess(self, data):
        ...
        # mixed modality data
        inputs_shared.update(self.get_modality_data(data,"normal"))
