...
from ..models.wan_video_dit_pbr_video_ablation_1_frame_cat_single_lora_v1 import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_14b_t2v_pbr_lora_video_ablation1_framecat_single_lora_train_v1(DiffusionTrainingModule): 
    def __init__(
        self,
    ...
    def forward_preprocess(self, data):
        ...
        elif inputs_shared["training_mode"] == "Inverse_Rendering" or inputs_shared["training_mode"] == "Reconstruction":
            prompt_list = [
                "",
            ]
            inputs_posi = {"prompt": prompt_list}
