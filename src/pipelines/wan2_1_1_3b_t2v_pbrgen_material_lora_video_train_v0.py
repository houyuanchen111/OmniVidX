"""
看能不能用lora训出一个t2 material video 的model
""" 
...
class WanVideoUnit_InputVideoEmbedder(PipelineUnit):
    # 将material和depth 分开encode到latent space
    def __init__(self):
        super().__init__(
...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_material_lora_video_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
    ...
    def forward_preprocess(self, data):
        ...
        # 只试试material的效果
        # input_videos = torch.cat((data["material"], data["depth"], data["material"], data["material"]), dim=0) # 4b c t h w
        input_videos = data["material"]
