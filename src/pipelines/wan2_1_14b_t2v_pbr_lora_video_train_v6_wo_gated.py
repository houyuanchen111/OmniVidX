...
from ..models.wan_video_dit_pbr_video_v3_wo_gated import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_14b_t2v_pbr_lora_video_train_v6_wo_gated(DiffusionTrainingModule): 
    def __init__(
        self,
