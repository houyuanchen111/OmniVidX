"""
实验三
加上新加的patch align attention，不过要给它一个gate或者residual 
self-attn 还是用lora
""" 
...
from ..models.wan_video_dit_wonder3d_v3 import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_fun_1_3b_control_normal_depth_wonder3d_image_train_v3(DiffusionTrainingModule): 
    def __init__(
        self,
