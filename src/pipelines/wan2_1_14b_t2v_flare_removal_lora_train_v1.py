...
class WanVideoUnit_PromptEmbedder(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, prompt, positive) -> dict:
        ...
        prompt_emb = prompt_emb.repeat(3, 1, 1) # 三种分支的prompt相同
...
class WanTrainingModule_wan2_1_14b_t2v_flare_removal_lora_train_v1(DiffusionTrainingModule): 
    def __init__(
        self,
    ...
    def forward_preprocess(self, data):
        ...
        if inputs_shared["training_mode"] == "Generation":
            ...
            inputs_posi = {"prompt": prompt + " There is a noticeable flare in the video."} # Generation的时候需要有prompt
        else:
            inputs_posi = {"prompt": ""}
