"""
rec loss v1: 直接加，这个应该是和intrinsix最为接近的
""" 
import torchvision
...
class WanVideoPipeline(BasePipeline):
    ...
    def training_loss(self, **inputs):
        ...
        # print(loss)
        loss = loss * self.scheduler.training_weight(timestep_weight) + loss_rec
        return loss
...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_gen_rec_loss_v1_lora_image_train_v1(DiffusionTrainingModule): 
    def __init__(
        self,
