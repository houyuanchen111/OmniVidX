...
from ..models.wan_video_dit_albedo_material_normal_wonder3d_v0 import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanVideoUnit_PromptEmbedder(PipelineUnit):
    ...
    def process(self, pipe: WanVideoPipeline, prompt, positive) -> dict:
        if isinstance(prompt, list):
            prompt = prompt * 3 # 这边在不同prompt的情况下要修改
...
class WanTrainingModule_wan2_1_fun_1_3b_control_albedo_material_normal_wonder3d_image_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
