...
from ..models.wan_video_dit_pbr_sft_rec import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_lora_image_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
