"""
看能不能用lora训出一个t2 normal video 的model
""" 
...
from ..models.wan_video_dit_albedo_material_normal_gen import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_albedo_material_normal_lora_video_wo_dm_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
        ...
        # 放开 WanModel 中的 domain_embedding 这个是要放开的
    ...
    def forward_preprocess(self, data):
        ...
        inputs_shared = {
            "batch_size": data["albedo"].shape[0],
            "height": data["height"],
            "width": data["width"],
        ...
        # 只试试normal的效果
        # input_videos = torch.cat((data["normal"], data["depth"], data["material"], data["normal"]), dim=0) # 4b c t h w
