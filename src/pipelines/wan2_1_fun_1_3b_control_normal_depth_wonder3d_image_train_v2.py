"""
实验二
去掉新加的patch align attention 
放开self-attn，而非使用lora
""" 
...
from ..models.wan_video_dit_wonder3d_v2 import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_fun_1_3b_control_normal_depth_wonder3d_image_train_v2(DiffusionTrainingModule): 
    def __init__(
        self,
