...
class WanVideoPipeline(BasePipeline):
    ...
    def training_loss(self, **inputs):
        ...
        loss = (loss + 0.5 * loss_rec) * self.scheduler.training_weight(timestep_weight) 
        return loss
...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_gen_render_loss_lora_image_train_v1(DiffusionTrainingModule): 
    def __init__(
        self,
