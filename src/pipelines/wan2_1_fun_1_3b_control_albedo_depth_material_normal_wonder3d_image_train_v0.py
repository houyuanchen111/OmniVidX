    ...
    def __call__(
        ...
        **kwargs 
        ...
        try:
            ...
            b = 1 # inference的时候batch_size默认是1
        ...
        try:
            ...
            print("没有input_videos, 请检查是否是inference模式")
...
class WanTrainingModule_wan2_1_fun_1_3b_control_albedo_depth_material_normal_wonder3d_image_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
