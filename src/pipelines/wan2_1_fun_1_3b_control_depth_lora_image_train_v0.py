...
class WanVideoPipeline(BasePipeline):
    ...
    def __call__(
        ...
        **kwargs 
        ...
        video_dict = {}
        inputs_shared["modality_index"] = torch.tensor([2], device=self.device) # 强制算depth的loss
...
class WanTrainingModule_wan2_1_fun_1_3b_control_depth_lora_image_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
    ...
    def forward_preprocess(self, data):
        ...
        # mixed modality data
        inputs_shared.update(self.get_modality_data(data,"depth"))
