...
from ..models.wan_video_dit_pbr_video_v3_w_channel_concat import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_14b_t2v_pbr_lora_video_train_v6_w_channel_concat(DiffusionTrainingModule): 
    def __init__(
        self,
