"""
实验一
去掉新加的patch align attention 结果会怎样？
""" 
...
from ..models.wan_video_dit_wonder3d_v1 import WanModel, RMSNorm, sinusoidal_embedding_1d
...
class WanTrainingModule_wan2_1_fun_1_3b_control_normal_depth_wonder3d_image_train_v1(DiffusionTrainingModule): 
    def __init__(
        self,
