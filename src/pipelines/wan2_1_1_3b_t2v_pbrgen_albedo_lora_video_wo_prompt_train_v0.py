...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_albedo_lora_video_wo_prompt_train_v0(DiffusionTrainingModule): 
    def __init__(
        self,
    ...
    def forward_preprocess(self, data):
        ...
        inputs_posi = {"prompt": [""] * batch_size} # 空prompt
        inputs_nega = {}
