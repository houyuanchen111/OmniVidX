"""
render loss v1: 仅仅只加render loss，结果会怎样？
""" 
import torchvision
...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_gen_render_loss_v1_lora_image_train_v1(DiffusionTrainingModule): 
    def __init__(
        self,
