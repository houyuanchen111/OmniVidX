"""
在生成的时候, 保留rgb branch(时间步和其余模态保持一致，看能否缓解overfit到训练场景的问题)
""" 
import torchvision
...
class WanTrainingModule_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_gen_lora_image_train_v1(DiffusionTrainingModule): 
    def __init__(
        self,
