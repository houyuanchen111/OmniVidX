...
class SelfAttention(nn.Module):
    ...
    def forward(self, x, freqs, drop_out: float = 0.25, training_mode: str = None): # drop_out=0.25
        if training_mode == "Generation":
            q = self.q(x, adapter_names=["cam1", "cam2", "cam3", "cam4"])
            k = self.k(x, adapter_names=["cam1", "cam2", "cam3", "cam4"])
            v = self.v(x, adapter_names=["cam1", "cam2", "cam3", "cam4"])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=["cam1", "cam2", "cam3", "cam4"])
        elif training_mode == "cam1":
            q = self.q(x, adapter_names=[None, "cam2", "cam3", "cam4"])
            k = self.k(x, adapter_names=[None, "cam2", "cam3", "cam4"])
            v = self.v(x, adapter_names=[None, "cam2", "cam3", "cam4"])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=[None, "cam2", "cam3", "cam4"])
        elif training_mode == "cam2":
            q = self.q(x, adapter_names=["cam1", None, "cam3", "cam4"])
            k = self.k(x, adapter_names=["cam1", None, "cam3", "cam4"])
            v = self.v(x, adapter_names=["cam1", None, "cam3", "cam4"])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=["cam1", None, "cam3", "cam4"])
        elif training_mode == "cam3":
            q = self.q(x, adapter_names=["cam1", "cam2", None, "cam4"])
            k = self.k(x, adapter_names=["cam1", "cam2", None, "cam4"])
            v = self.v(x, adapter_names=["cam1", "cam2", None, "cam4"])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=["cam1", "cam2", None, "cam4"])
        elif training_mode == "cam4":
            q = self.q(x, adapter_names=["cam1", "cam2", "cam3", None])
            k = self.k(x, adapter_names=["cam1", "cam2", "cam3", None])
            v = self.v(x, adapter_names=["cam1", "cam2", "cam3", None])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=["cam1", "cam2", "cam3", None])
        else:
...
class DiTBlock(nn.Module):
    ...
    def forward(self, x, context, t_mod, freqs, drop_out: float = 0.25, training_mode: str = None): 
