...
class SelfAttention(nn.Module):
    ...
    def forward(self, x, freqs, drop_out: float = 0.25, training_mode: str = None): # drop_out=0.25
        if training_mode == "RGBAGeneration":
            q = self.q(x, adapter_names=["com", "pha", "fgr", "bgr"])
            k = self.k(x, adapter_names=["com", "pha", "fgr", "bgr"])
            v = self.v(x, adapter_names=["com", "pha", "fgr", "bgr"])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=["com", "pha", "fgr", "bgr"])
            ...
            q = self.q(x, adapter_names=["com", None, None, "bgr"])
            k = self.k(x, adapter_names=["com", None, None, "bgr"])
            v = self.v(x, adapter_names=["com", None, None, "bgr"])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=["com", None, None, "bgr"])
            ...
            q = self.q(x, adapter_names=["com", "pha", "fgr", None])
            k = self.k(x, adapter_names=["com", "pha", "fgr", None])
            v = self.v(x, adapter_names=["com", "pha", "fgr", None])
            q = self.norm_q(q)
            k = self.norm_k(k)
            q = rope_apply(q, freqs, self.num_heads)
            k = rope_apply(k, freqs, self.num_heads)
            x = self.attn(q, k, v, drop_out=drop_out)
            result = self.o(x, adapter_names=["com", "pha", "fgr", None])
        else:
            print("wrong!!!!")
        return result
