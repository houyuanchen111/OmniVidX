...
class ModelCheckpointCallback_wan2_1_fun_1_3b_control_normal_depth_wonder3d_image_train_v2(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_fun_1_3b_control_normal_depth_wonder3d_image_train_v2(Callback):    
...
class Trainer_wan2_1_fun_1_3b_control_normal_depth_wonder3d_image_train_v2:
    def __init__(
            self, 
            model, 
            optimizer, 
