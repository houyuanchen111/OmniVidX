...
class ModelCheckpointCallback_wan2_1_14b_t2v_matte_lora_video_train_v3(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_14b_t2v_matte_lora_video_train_v3(Callback):    
...
class Trainer_wan2_1_14b_t2v_matte_lora_video_train_v3:
    def __init__(
            self, 
            model, 
            optimizer, 
    ...
    def validate(self):
        ...
        inference_params = {
            ...
            "一位身穿淡雅汉服的古典女子在眺望远方。白色剪影，纯黑色背景。",
            "一位身穿淡雅汉服的古典女子在眺望远方。纯黑色背景。",
            "古代繁华的洛阳城内。",
            ],
        ...
        if inference_pha is not None and inference_fgr is not None:
            inference_params = {
                "prompt": 
                [
                    val_batch.get("fgr_prompt", [""])[0] + "背景为:东京繁华的街头。",
                    "",
                    "",
                    "东京繁华的街头。"
                ],
