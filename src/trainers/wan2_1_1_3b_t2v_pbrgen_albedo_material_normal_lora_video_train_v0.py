...
class ModelCheckpointCallback_wan2_1_1_3b_t2v_pbrgen_albedo_material_normal_lora_video_train_v0(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_1_3b_t2v_pbrgen_albedo_material_normal_lora_video_train_v0(Callback):    
...
class Trainer_wan2_1_1_3b_t2v_pbrgen_albedo_material_normal_lora_video_train_v0:
    def __init__(
            self, 
            model, 
            optimizer, 
    ...
    def train(self):
        ...
        for epoch_id in range(self.num_epochs):
            ...
            # 跳过验证推理，仅执行保存权重的回调
            if self.epoch_id % 99 == 0: # 每100个epoch做一次验证
                if self.accelerator.is_main_process:
                    try:
