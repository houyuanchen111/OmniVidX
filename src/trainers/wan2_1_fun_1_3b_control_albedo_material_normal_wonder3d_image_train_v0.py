...
class ModelCheckpointCallback_wan2_1_fun_1_3b_control_albedo_material_normal_wonder3d_image_train_v0(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_fun_1_3b_control_albedo_material_normal_wonder3d_image_train_v0(Callback):    
...
class Trainer_wan2_1_fun_1_3b_control_albedo_material_normal_wonder3d_image_train_v0:
    def __init__(
            self, 
            model, 
            optimizer, 
