...
class ModelCheckpointCallback_wan2_1_fun_1_3b_control_mixed_modality_serial_train_v1(Callback):    
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_fun_1_3b_control_mixed_modality_serial_train_v1(Callback):
...
class Trainer_wan2_1_fun_1_3b_control_mixed_modality_serial_train_v1:
    def __init__(
            self, 
            model, 
            optimizer, 
    ...
    def train(self):
        ...
        for epoch_id in range(self.num_epochs):
            ...
            if epoch_id % 5 == 0:
                ...
                self.val_loss = 0.0  # 非验证epoch设置默认值
