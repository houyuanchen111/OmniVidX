...
class ModelCheckpointCallback_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_gen_lora_image_train_v0(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_gen_lora_image_train_v0(Callback):    
...
class Trainer_wan2_1_1_3b_t2v_pbrgen_pbr_sft_rec_gen_lora_image_train_v0:
    def __init__(
            self, 
            model, 
            optimizer, 
