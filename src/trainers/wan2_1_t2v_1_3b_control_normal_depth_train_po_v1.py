...
class ModelCheckpointCallback_wan2_1_t2v_1_3b_control_normal_depth_train_po_v1(Callback):
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_t2v_1_3b_control_normal_depth_train_po_v1(Callback):
...
class Trainer_wan2_1_t2v_1_3b_control_normal_depth_train_po_v1:
    def __init__(
            self, 
            model, 
            optimizer, 
