...
class ModelCheckpointCallback_wan2_1_14b_t2v_pbr_lora_video_train_v7_wo_attn(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_14b_t2v_pbr_lora_video_train_v7_wo_attn(Callback):    
...
class Trainer_wan2_1_14b_t2v_pbr_lora_video_train_v7_wo_attn:
    def __init__(
            self, 
            model, 
            optimizer, 
