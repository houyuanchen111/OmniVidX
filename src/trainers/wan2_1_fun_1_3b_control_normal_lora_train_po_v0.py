...
from ..pipelines.wan2_1_fun_1_3b_control_normal_lora_train_v0 import WanVideoUnit_ShapeChecker   
from ..pipelines.wan2_1_fun_1_3b_control_normal_lora_train_v0 import WanVideoUnit_NoiseInitializer
from ..pipelines.wan2_1_fun_1_3b_control_normal_lora_train_v0 import WanVideoUnit_InputVideoEmbedder
from ..pipelines.wan2_1_fun_1_3b_control_normal_lora_train_v0 import WanVideoUnit_PromptEmbedder
from ..pipelines.wan2_1_fun_1_3b_control_normal_lora_train_v0 import WanVideoUnit_FunControl # 一共五个模块

# 下面两个callback是需要定制化的，便于控制
class ModelCheckpointCallback_wan2_1_fun_1_3b_control_normal_lora_train_po_v0(Callback):
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_fun_1_3b_control_normal_lora_train_po_v0(Callback):
...
class WanTrainingModule_wan2_1_fun_1_3b_control_normal_lora_train_po_v0(DiffusionTrainingModule):
    def __init__(
        self,
        ...
        self.pipe = WanVideoPipeline.from_pretrained(torch_dtype=torch.bfloat16, device=device, tokenizer_config=tokenizer_config, model_configs=model_configs,redirect_common_files=False)
...
class Trainer_wan2_1_fun_1_3b_control_normal_lora_train_po_v0:
    def __init__(
            self, 
            model, 
            optimizer, 
