...
class ModelCheckpointCallback_wan2_1_14b_t2v_matte_lora_video_train_v4(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_14b_t2v_matte_lora_video_train_v4(Callback):    
...
class Trainer_wan2_1_14b_t2v_matte_lora_video_train_v4:
    def __init__(
            self, 
            model, 
            optimizer, 
