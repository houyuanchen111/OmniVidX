...
class ModelCheckpointCallback_wan2_1_14b_t2v_pbr_lora_video_train_v6(Callback):     
    """
    checkpoint callback
    """
...
class TensorboardLoggingCallback_wan2_1_14b_t2v_pbr_lora_video_train_v6(Callback):    
...
class Trainer_wan2_1_14b_t2v_pbr_lora_video_train_v6:
    def __init__(
            self, 
            model, 
            optimizer, 
        ...
        self.training_mode_to_dataloader = {
            # _v 后缀：视频数据
            "t2RAIN_v": self.t2RAIN_dataloader,
            ...
            "R2AIN_i": self.frame_R2AIN_dataloader,
    ...
    def train(self):
        ...
        for epoch_id in range(self.num_epochs):
            ...
            if self.video_dataloader is not None:
                ...
                max_steps = max((len(dl) for dl in self.training_mode_to_dataloader.values() if dl is not None), default=1000)
